...
export function html2xmlstr(html) {
    ...
    let docXml = dom.window.document.implementation.createDocument(NAMESPACE, '', null);
    ...
    return new dom.window.XMLSerializer().serializeToString(docXml).normalize();
}
